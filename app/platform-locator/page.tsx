      ...
      <div className="bg-white rounded-[2.5rem] shadow-premium p-10 border border-gray-100">
        ...
        {result && (
          <div className="mt-12 p-10 bg-brand/5 rounded-3xl border-2 border-brand/10 text-center animate-in zoom-in-95">
            ...
            <div className="inline-flex flex-col items-center justify-center bg-white w-48 h-48 rounded-full shadow-xl shadow-brand/10 border border-brand/10 mb-4">
              <span className="text-xs font-black text-gray-400 uppercase tracking-widest block mb-2">Platform</span>
              <span className="text-7xl font-black text-brand tracking-tighter leading-none">{result.platform}</span>
            </div>
          </div>
        )}
      </div>
