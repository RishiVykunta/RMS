...
async function main() {
  ...
  const stops = [
    ...
    { code: 'AJJ', arr: '22:43', dep: '22:45', dur: '2min', dist: '428 km', platform: '01', day: 1 },
    { code: 'PER', arr: '23:35', dep: '23:40', dur: '5min', dist: '491 km', platform: '07', day: 1 },
    { code: 'OGL', arr: '04:48', dep: '04:50', dur: '2min', dist: '783 km', platform: '05', day: 2 },
    { code: 'BZA', arr: '07:20', dep: '07:30', dur: '10min', dist: '921 km', platform: '01', day: 2 },
    { code: 'RJY', arr: '09:58', dep: '10:00', dur: '2min', dist: '1070 km', platform: '04', day: 2 },
    { code: 'VSKP', arr: '13:35', dep: '13:55', dur: '20min', dist: '1271 km', platform: '01', day: 2 },
    { code: 'VZM', arr: '14:45', dep: '14:50', dur: '5min', dist: '1331 km', platform: '02', day: 2 },
    { code: 'CHE', arr: '15:38', dep: '15:40', dur: '2min', dist: '1401 km', platform: '04', day: 2 },
    { code: 'PSA', arr: '16:48', dep: '16:50', dur: '2min', dist: '1474 km', platform: '03', day: 2 },
    { code: 'BAM', arr: '17:45', dep: '17:50', dur: '5min', dist: '1548 km', platform: '01', day: 2 },
    { code: 'BALU', arr: '18:43', dep: '18:45', dur: '2min', dist: '1623 km', platform: '03', day: 2 },
    { code: 'KUR', arr: '19:45', dep: '19:55', dur: '10min', dist: '1694 km', platform: '02', day: 2 },
    { code: 'BBS', arr: '20:20', dep: '20:25', dur: '5min', dist: '1713 km', platform: '04', day: 2 },
    { code: 'CTC', arr: '20:55', dep: '21:00', dur: '5min', dist: '1741 km', platform: '01', day: 2 },
    { code: 'JJKR', arr: '21:48', dep: '21:50', dur: '2min', dist: '1813 km', platform: '02', day: 2 },
    { code: 'BHC', arr: '22:48', dep: '22:50', dur: '2min', dist: '1856 km', platform: '03', day: 2 },
    { code: 'BLS', arr: '23:37', dep: '23:39', dur: '2min', dist: '1919 km', platform: '01', day: 2 },
    { code: 'KGP', arr: '01:10', dep: '01:18', dur: '8min', dist: '2037 km', platform: '02', day: 3 },
    { code: 'DKAE', arr: '04:02', dep: '04:07', dur: '5min', dist: '2159 km', platform: '03', day: 3 },
    { code: 'BHP', arr: '06:08', dep: '06:13', dur: '5min', dist: '2290 km', platform: '04', day: 3 },
    { code: 'RPH', arr: '07:19', dep: '07:21', dur: '2min', dist: '2350 km', platform: '03', day: 3 },
    { code: 'NFK', arr: '09:23', dep: '09:25', dur: '2min', dist: '2437 km', platform: '02', day: 3 },
    { code: 'MLDT', arr: '10:25', dep: '10:35', dur: '10min', dist: '2472 km', platform: '01', day: 3 },
    { code: 'KNE', arr: '12:38', dep: '12:40', dur: '2min', dist: '2617 km', platform: '01', day: 3 },
    { code: 'NJP', arr: '14:05', dep: '14:15', dur: '10min', dist: '2704 km', platform: '04', day: 3 },
    { code: 'DQG', arr: '15:38', dep: '15:40', dur: '2min', dist: '2770 km', platform: '05', day: 3 },
    { code: 'NCB', arr: '16:38', dep: '16:43', dur: '5min', dist: '2830 km', platform: '03', day: 3 },
    { code: 'NOQ', arr: '17:00', dep: '17:02', dur: '2min', dist: '2849 km', platform: '01', day: 3 },
    { code: 'KOJ', arr: '18:05', dep: '18:07', dur: '2min', dist: '2928 km', platform: '03', day: 3 },
    { code: 'NBQ', arr: '18:50', dep: '19:00', dur: '10min', dist: '2956 km', platform: '01', day: 3 },
    { code: 'BPRD', arr: '19:45', dep: '19:47', dur: '2min', dist: '3000 km', platform: '01', day: 4 },
    { code: 'RNY', arr: '20:50', dep: '20:55', dur: '5min', dist: '3065 km', platform: '02', day: 4 },
    { code: 'KYQ', arr: '22:40', dep: '22:42', dur: '2min', dist: '3106 km', platform: '04', day: 4 },
    { code: 'GHY', arr: '22:55', dep: '23:10', dur: '15min', dist: '3112 km', platform: '01', day: 4 },
    { code: 'HJI', arr: '01:20', dep: '01:22', dur: '2min', dist: '3248 km', platform: '01', day: 4 },
    { code: 'LMG', arr: '02:30', dep: '02:40', dur: '10min', dist: '3293 km', platform: '03', day: 4 },
    { code: 'MBG', arr: '04:05', dep: '04:07', dur: '2min', dist: '3357 km', platform: '04', day: 4 },
    { code: 'NHLG', arr: '05:20', dep: '05:25', dur: '5min', dist: '3391 km', platform: '01', day: 4 },
    { code: 'BPB', arr: '08:30', dep: '08:45', dur: '15min', dist: '3462 km', platform: '01', day: 4 },
    { code: 'SCL', arr: '10:45', dep: 'ENDS', dur: '-', dist: '3492 km', platform: '04', day: 4 },
  ];
